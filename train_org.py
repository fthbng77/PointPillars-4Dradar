...
def main(args):
    ...
    for epoch in range(args.max_epoch):
        ...
        for i, data_dict in enumerate(tqdm(train_dataloader)):
            ...
            print(f"[DEBUG] batched_pts lens: {len(batched_pts)}")
            print(f"[DEBUG] gt bboxes lens: {[b.shape for b in batched_gt_bboxes]}")
            print(f"[DEBUG] gt labels lens: {[l.shape for l in batched_labels]}")
            ...
            print(f"[DEBUG] bbox_cls_pred: {bbox_cls_pred.shape}")
            print(f"[DEBUG] bbox_pred: {bbox_pred.shape}")
            print(f"[DEBUG] bbox_dir_cls_pred: {bbox_dir_cls_pred.shape}")
